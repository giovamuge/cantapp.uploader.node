...
const file = path.join(__dirname, "./upload/canzoniere.docx");

var zip = new JSZip();
var zipData = zip.file(file, { base64: true });
console.log(zipData);
return;
zipData.loadAsync().then((val) => {
  var doc = new Docxtemplater().loadZip(val);
